...
| 3 | Dispatch/Ops Worker | Schedule jobs, update customers, close out work, and reduce handoff misses | `schedule.propose`, `customer_update.draft`, and `closeout.prepare` are runtime; launch still needs exception routing and live credential gates |
