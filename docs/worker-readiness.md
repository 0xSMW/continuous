...
| Dispatch/Ops | partial | partial | partial | partial | partial | partial | partial | partial | partial | partial | partial | First `schedule.propose` slice is registered and CI-covered; customer update, closeout, exception routing, and live calendar credentials remain blocked | Extend Dispatch beyond schedule proposal into customer update drafts, closeout packets, and exception routing before launch |
