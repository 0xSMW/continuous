...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Revenue Operations | live | live | live | live | live | live | live | partial | live | partial | partial | Production connector credentials and approved external send remain blocked; scheduler polling needs real connection coverage | Provision production connector credentials, enable pollable active connections, then prove scoped adapter execution with receipt and rollback proof |
