...
if [ ! -f .env ]; then
  ...
  umask 077
  {
    ...
    printf 'CONTROL_PLANE_ALLOWED_WORKER_ROLES=revenue_operations,owner_chief_of_staff,dispatch_operations,finance_operations,workforce_operations,systems_operations\n'
...
set_control_plane_token_catalog() {
  ...
  allowed_commands='"core:view.summary","core:task.create","core:task.transition","core:object.upsert","core:adapter.upsert","core:connection.upsert","core:connection.health.record","core:entity.setup.record","core:object.link","core:event.ingest","core:evidence.attach","core:document.create","core:packet.prepare","core:document.packet.prepare","core:decision.record","core:approval.request","core:adapter.intent.record","core:rule.change.record","core:external_action.record","core:capability.grant","core:budget.reserve","core:budget.charge","core:budget.release","core:ai.infer","core:view.publish","core:customer_signal.record","core:payroll.preview.record","core:payroll.preview.packet.prepare","core:control_plane.token_rotation.attest","core:control_plane.credential.upsert","core:control_plane.credential.revoke","core:control_plane.session.review","worker:view.snapshot","worker:view.approvals","worker:view.briefs","worker:view.decisions","worker:view.board","worker:view.exceptions","worker:view.readiness","worker:view.health","worker:view.repairs","worker:run","worker:lead.read","worker:lead.classify","worker:response.draft","worker:quote.prepare","worker:schedule.propose","worker:customer_update.draft","worker:closeout.prepare","worker:exception.route","worker:invoice.prepare","worker:ar_followup.draft","worker:cash_forecast.generate","worker:payment_draft.prepare","worker:hire.packet.prepare","worker:payroll_input.prepare","worker:continue","worker:approval.decide","worker:adapters.reconcile","worker:adapters.retry","worker:brief.generate","worker:decision_queue.prepare","worker:anomaly.triage","worker:connector.health.scan","worker:sync.repair.plan","worker:data_quality.remediate","worker:permission.review","worker:automation.plan","workflow:view.overview","workflow:view.approvals","workflow:start","workflow:transition","workflow:steps.execute","workflow:approval.decide","approval:view.inbox","approval:approval.decide"'
  app_server_commands='"app_server:worker.schema","app_server:worker.view.snapshot","app_server:worker.view.approvals","app_server:worker.view.briefs","app_server:worker.view.decisions","app_server:worker.view.board","app_server:worker.view.exceptions","app_server:worker.view.readiness","app_server:worker.view.health","app_server:worker.view.repairs","app_server:worker.command.run","app_server:worker.command.lead.read","app_server:worker.command.lead.classify","app_server:worker.command.response.draft","app_server:worker.command.quote.prepare","app_server:worker.command.schedule.propose","app_server:worker.command.customer_update.draft","app_server:worker.command.closeout.prepare","app_server:worker.command.exception.route","app_server:worker.command.invoice.prepare","app_server:worker.command.ar_followup.draft","app_server:worker.command.cash_forecast.generate","app_server:worker.command.payment_draft.prepare","app_server:worker.command.hire.packet.prepare","app_server:worker.command.payroll_input.prepare","app_server:worker.command.continue","app_server:worker.command.approval.decide","app_server:worker.command.adapters.reconcile","app_server:worker.command.adapters.retry","app_server:worker.command.brief.generate","app_server:worker.command.decision_queue.prepare","app_server:worker.command.anomaly.triage","app_server:worker.command.connector.health.scan","app_server:worker.command.sync.repair.plan","app_server:worker.command.data_quality.remediate","app_server:worker.command.permission.review","app_server:worker.command.automation.plan"'
  allowed_commands="${allowed_commands},${app_server_commands}"
  catalog_json="$(
    printf '[{"id":"bootstrap-operator","tokenSha256":"%s","operatorEmail":"%s","allowedTenants":["continuous-demo"],"allowedWorkerRoles":["revenue_operations","owner_chief_of_staff","dispatch_operations","finance_operations","workforce_operations","systems_operations"],"allowedRoutes":["core","worker","workflow","approval","app_server"],"allowedAccess":["read","write"],"allowedCommands":[%s]}]' \
      "$token_hash" \
      "$WORKER_OPERATOR_EMAIL" \
      "$allowed_commands"
  )"
...
set_env CONTROL_PLANE_ALLOWED_WORKER_ROLES "revenue_operations,owner_chief_of_staff,dispatch_operations,finance_operations,workforce_operations,systems_operations"
