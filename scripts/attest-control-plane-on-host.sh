...
CONTROL_PLANE_ALLOWED_COMMANDS_JSON='[
  ...
  "app_server:worker.view.approvals",
  "app_server:worker.view.briefs",
  "app_server:worker.view.decisions",
  "app_server:worker.view.board",
  "app_server:worker.view.exceptions",
  "app_server:worker.view.readiness",
  "app_server:worker.view.obligations",
  "app_server:worker.view.packet",
  "app_server:worker.view.health",
  "app_server:worker.view.repairs",
  "app_server:worker.view.campaigns",
  "app_server:worker.command.run",
  "app_server:worker.command.lead.read",
  "app_server:worker.command.lead.classify",
  "app_server:worker.command.response.draft",
  "app_server:worker.command.quote.prepare",
  "app_server:worker.command.payment_link.prepare",
  "app_server:worker.command.schedule.propose",
  "app_server:worker.command.customer_update.draft",
  "app_server:worker.command.closeout.prepare",
  "app_server:worker.command.exception.route",
  "app_server:worker.command.invoice.prepare",
  "app_server:worker.command.ar_followup.draft",
  "app_server:worker.command.cash_forecast.generate",
  "app_server:worker.command.payment_draft.prepare",
  ...
  "app_server:worker.command.adapters.retry",
  "app_server:worker.command.brief.generate",
  "app_server:worker.command.decision_queue.prepare",
  "app_server:worker.command.anomaly.triage",
  "app_server:worker.command.connector.health.scan",
  "app_server:worker.command.sync.repair.plan",
  "app_server:worker.command.data_quality.remediate",
  "app_server:worker.command.permission.review",
  ...
  "app_server:core.command.adapter.upsert",
  "app_server:core.command.connection.upsert",
  "app_server:core.command.connection.health.record",
  "app_server:core.command.entity.setup.record",
  ...
  "app_server:core.command.object.link",
  "app_server:core.command.event.ingest",
  "app_server:core.command.evidence.attach",
  "app_server:core.command.document.create",
  "app_server:core.command.packet.prepare",
  "app_server:core.command.document.packet.prepare",
  "app_server:core.command.decision.record",
  "app_server:core.command.approval.request",
  "app_server:core.command.adapter.intent.record",
  "app_server:core.command.rule.change.record",
  "app_server:core.command.obligation.scan",
  "app_server:core.command.external_action.record",
  "app_server:core.command.capability.grant",
  "app_server:core.command.budget.reserve",
  "app_server:core.command.budget.charge",
  "app_server:core.command.budget.release",
  "app_server:core.command.ai.infer",
  "app_server:core.command.view.publish",
  "app_server:core.command.customer_signal.record",
  "app_server:core.command.payroll.preview.record",
  "app_server:core.command.payroll.preview.packet.prepare",
