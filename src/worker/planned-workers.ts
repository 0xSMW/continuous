...
export const workerExpansionCatalog: WorkerExpansionCatalogEntry[] = [
  ...
  },
  {
    ...
    firstBlocker: "External customer send remains blocked until approved send credentials, rollback proof, and receipt capture exist.",
    launchGate: "Runtime recovery draft packet, generated signals view, approval request, and no-send proof.",
    contractPath: "docs/customer-experience-worker-v1-contract.md",
    evidencePacket: "customer_experience_packet",
    externalExecution: "blocked",
    autonomyLevel: 2,
