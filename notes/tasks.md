...
- Extend Core command replay fingerprints beyond `task.create` and `task.transition`, then harden managed control-plane credential authority and adapter auth redaction before broad operator use.
