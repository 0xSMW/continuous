...
- Harden Core command idempotency, Core/Workflow/Approval auth-before-body and body-size handling, managed control-plane credential authority, authenticated malformed-request audit logging, and adapter auth redaction before broad operator use.
