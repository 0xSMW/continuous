...
- Provision production inbox and CRM credentials, enable pollable active connections, and monitor scheduler coverage behind the persisted connection-backed `lead.read` source-reader shape.
