...
- Finish Core command replay fingerprints for payroll, control-plane auth, and AI gateway commands; approval, capability, and budget commands now reject changed-input replays, and managed control-plane credential authority still needs hardening before broad operator use.
