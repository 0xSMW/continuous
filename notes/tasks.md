...
- Finish Core command replay fingerprints for control-plane auth and AI gateway commands; approval, capability, budget, and payroll commands now reject changed-input replays, and managed control-plane credential authority still needs hardening before broad operator use.
