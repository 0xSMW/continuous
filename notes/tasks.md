...
- Provision production inbox and CRM managed credential refs, create pollable active connections through `/core connection.upsert`, and monitor scheduler coverage behind the persisted connection-backed `lead.read` source-reader shape.
