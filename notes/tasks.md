...
- Harden Core command idempotency, managed control-plane credential authority, adapter auth redaction, and per-command replay fingerprints before broad operator use.
